...
class ContactController extends BaseAdminController{
	...
	public function listView(){
		...
		$search['contact_type'] = (int)Request::get('contact_type', -1);
		...
		$optionType = Utility::getOption($this->arrType, $search['contact_type']);
	...
	public function getItem($id=0){
		...
		$optionType = Utility::getOption($this->arrType, isset($data['contact_type'])? $data['contact_type'] : CGlobal::status_hide);
	...
	public function postItem($id=0){
		...
		$dataSave = array(
				...
				'contact_type'=>array('value'=>(int)Request::get('contact_type'),'require'=>0),
