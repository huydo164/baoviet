								...
								<table class="table table-bordered table-hover">
									...
									<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td><?php if(isset($item['author_id'])): ?> <?php echo e(\App\Modules\Models\Author::getName($item->author_id)); ?> <?php endif; ?> </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\baoviet\app\Modules/Admin/Views/statics/list.blade.php ENDPATH**/ ?>