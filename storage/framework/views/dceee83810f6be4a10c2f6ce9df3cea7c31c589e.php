                ...
                <div class="row">
                    <div class="col-xs-12">
                            ...
                            <form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
                                <div class="panel-body panel-search">
                                    <div class="form-group col-lg-2">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-sm" name="video_title" <?php if(isset($search['video_title']) && $search['video_title'] !=''): ?>value="<?php echo e($search['video_title']); ?>"<?php endif; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-2">
                                ...
                                <div class="panel-footer text-right">
                                    <a class="btn btn-default btn-sm" class="reset" href="<?php echo e(route('admin.video')); ?>"><i class="fa fa-recycle"></i>Bỏ lọc</a>
                                    <a class="btn btn-danger btn-sm" href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/video/edit"><i class="ace-icon fa fa-plus-circle"></i>Thêm mới</a>
                        ...
                        <?php if(sizeof($data) > 0): ?>
                            ...
                            <?php endif; ?>
                            <br>
                            <form id="formListItem" method="POST" action="<?php echo e(FuncLib::getBaseUrl()); ?>admin/video/delete" class="formListItem" name="txtForm">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <label class="pos-rel">
                                                    <input class="ace checkItem" name="checkItem[]" value="<?php echo e($item['video_id']); ?>" type="checkbox">
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            <td><a target="_blank" title="<?php echo e($item->video_title); ?>" href="#"><?php echo e($item['video_title']); ?></a></td>
                                            <td>
                                                <?php if(isset($arrCate[$item['video_catid']])): ?> <?php echo e($arrCate[$item['video_catid']]); ?> <?php endif; ?>
                                            </td>
                                            <td><?php echo e($item['video_order_no']); ?></td>
                                            <td><?php echo e(date('d/m/Y', $item['video_created'])); ?></td>
                                            <td>
                                                <?php if($item['video_focus'] == '1'): ?>
                                            ...
                                            <td>
                                                <a href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/video/edit/<?php echo e($item['video_id']); ?>" title="Cập nhật">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\baoviet\app\Modules/Admin/Views/video/list.blade.php ENDPATH**/ ?>