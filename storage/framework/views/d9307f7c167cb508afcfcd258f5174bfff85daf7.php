                                            ...
                                            <div class="tab-pane panelDetail active" id="tabNoiDung" role="tabpanel">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="file" class="form-control input-sm" name="statics_video" value="<?php if(isset($data['statics_video'])): ?><?php echo e($data['statics_video']); ?> <?php endif; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
...
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\baoviet\app\Modules/Admin/Views/statics/add.blade.php ENDPATH**/ ?>