		...
		<div class="main-content-inner">
			<div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">Quản lý thông tin liên hệ</li>
				</ul>
			</div>
							...
							<form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
								<div class="panel-body panel-search">
									<div class="form-group col-lg-2">
										...
										<div>
											<input type="text" class="form-control input-sm" name="contact_title" <?php if(isset($search['contact_title']) && $search['contact_title'] !=''): ?>value="<?php echo e($search['contact_title']); ?>"<?php endif; ?>>
										</div>
									</div>
									<div class="form-group col-lg-2">
										<label class="control-label">Kiểu</label>
										<div>
											<select name="contact_type" class="form-control input-sm">
												<?php echo $optionType; ?>
								...
								<table class="table table-bordered table-hover">
									...
									<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td>
												<?php if(isset($arrType[$item['contact_type']])): ?> <?php echo e($arrType[$item['contact_type']]); ?> <?php endif; ?>
											</td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\baoviet\app\Modules/Admin/Views/contact/list.blade.php ENDPATH**/ ?>