                    ...
                    <div class="page-wrapper">
                        <div class="blog-title-area text-center">
                            <ol class="breadcrumb hidden-xs-down">
                                ...
                                <li class="breadcrumb-item active"><?php echo e($data->statics_title); ?></li>
                            </ol>

                            <span class="color-orange"><a href="tech-category-01.html" title=""><?php echo e($data->statics_cat_name); ?></a></span>

                            <h3><?php echo e($data->statics_title); ?></h3>

                            <div class="blog-meta big-meta">
                                <small><a href="tech-single.html" title=""><?php echo e($data->statics_cat_name); ?></a></small>
                                ...
                                <small><a href="#" title=""><i class="fa fa-eye"></i> <?php echo e($data->statics_view_num); ?></a></small>
                            </div>
                            <!-- end meta -->
                        ...
                        <div class="blog-content">
                            <?php echo e(strip_tags($data->statics_content)); ?>
                                        ...
                                        <div class="blog-box">
                                            <div class="post-media">
                                                <a href="<?php echo e(FuncLib::buildLinkDetailStatic($item->statics_id, $item->statics_title)); ?>" title="">
                                                    <img src="<?php echo e(ThumbImg::thumbBaseNormal(CGlobal::FOLDER_STATICS, $item->statics_id, $item->statics_image, 800, 0, '', true, true)); ?>" alt="" class="img-fluid">
                                            ...
                                            <div class="blog-meta">
                                                ...
                                                <small><a href="blog-category-01.html" title=""><?php echo e($item->statics_cat_name); ?></a></small>
                                                <small><a href="blog-category-01.html" title=""><?php echo e(date('d/m/Y', $item->statics_date)); ?></a></small>
                                            </div>
                                            <!-- end meta -->
                                        </div>
                                        <!-- end blog-box -->
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-wrapper" >
                                        ...
                                        <input type="hidden" id="statics_id" value="<?php echo e($data->statics_id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Statics::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\baoviet\app\Modules/Statics/Views/content/pageStaticInfo.blade.php ENDPATH**/ ?>