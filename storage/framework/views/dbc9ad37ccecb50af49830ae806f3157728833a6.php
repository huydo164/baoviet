        ...
        <div class="main-content-inner">
            <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if($id==0): ?>Thêm mới <?php else: ?> Sửa <?php endif; ?> Video</li>
                </ul>
            </div>
                                            ...
                                            <div class="tab-pane panelDetail active" id="tabNoiDung" role="tabpanel">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="video_title" value="<?php if(isset($data['video_title'])): ?><?php echo e($data['video_title']); ?><?php endif; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <input name="image_primary" type="hidden" id="image_primary" value="<?php if(isset($data['video_image'])): ?><?php echo e(trim($data['video_image'])); ?><?php endif; ?>">
                                                                </div>
                                                                <!--Hien Thi Anh-->
                                                                        ...
                                                                        <?php $__currentLoopData = $news_image_other; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <li id="sys_div_img_other_<?php echo e($k); ?>">
                                                                                <div class="div_img_upload">
                                                                                    ...
                                                                                    <br/>
                                                                                    <a href="javascript:void(0);" id="sys_delete_img_other_<?php echo e($k); ?>" onclick="UploadAdmin.removeImage('<?php echo e($k); ?>', '<?php echo e($data['video_id']); ?>', '<?php echo e($v['img_other']); ?>', '7');">Xóa ảnh</a>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control" name="video_youtube" value="<?php if(isset($data['video_youtube'])): ?><?php echo e($data['video_youtube']); ?> <?php endif; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div id="sys_show_video">
                                                            <?php if($data->video_path != ''): ?>
                                                                <div class="video-upload" style="display: inline-block; text-align: center" >
                                                                    ...
                                                                    <br/>
                                                                    <a href="javascript:void(0);" id="sys_delete_img_other" onclick="UploadAdmin.removeVideo('<?php echo e($data['video_id']); ?>', '<?php echo e($data['video_path']); ?>', '8');">Xóa Video</a>
                                                                    <span style="display: none"><b><?php echo e($k); ?></b></span>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="video_intro"><?php if(isset($data['video_intro'])): ?><?php echo e(stripslashes($data['video_intro'])); ?><?php endif; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="video_content"><?php if(isset($data['video_content'])): ?><?php echo e(stripslashes($data['video_content'])); ?><?php endif; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm" name="video_order_no" value="<?php if(isset($data['video_order_no'])): ?><?php echo e($data['video_order_no']); ?><?php endif; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <?php if(isset($arrTag)): ?>
                                                                <?php $__currentLoopData = $arrTag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <label>
                                                                        <input type="checkbox" <?php if(in_array($item->tag_id, $video_tag_key)): ?> checked <?php endif; ?> name="video_tag[<?php echo e($item->tag_id); ?>]" value="<?php echo e($item->tag_title); ?>">
...
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\baoviet\app\Modules/Admin/Views/video/add.blade.php ENDPATH**/ ?>